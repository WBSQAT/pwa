...
export function execute(UserId) {
...
export function manageAuth() {
  console.log("asszxczxczdd");
  authenticate().then(loadClient);
}

$(document).ready(function () {
  document.getElementById('gAuth').addEventListener('click', manageAuth);
  document.getElementById('fAuth').addEventListener('click', login);
});
